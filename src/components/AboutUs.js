            ...
            <Layout className=' bg-transparent z-20 mx-32 xl:mx-12 lg:mx-6'>
                ...
                <div className="grid grid-cols-2 lg:flex lg:flex-col gap-16 2xl:gap-9 xl:gap-6">
                    <div className="flex flex-col items-center">
                        ...
                        <h2 className='Capitalize font-bold text-Dark text-5xl text-center 
    leading-[60px] py-6  border-y-2 border-primaryDark '>UNITED PACKAGING CONSOLIDATORS</h2>
                        <div className="flex justify-between pt-3 ">
                            <h6 className='font-bold text-xl text-primaryDark  p-5 mx-2' >Accessible</h6>
                            <h6 className='font-bold text-xl text-primaryDark p-5 mx-2' >Adaptable</h6>
                            <h6 className='font-bold text-xl text-primaryDark p-5 mx-2' >Affordable</h6>
                        </div>
                    ...
                    <motion.div className='flex flex-col '>
                        <motion.p
                            ...
                            viewport={{ once: true }}
                            className='p-2 text-xl text-dark font-normal leading-[2.25rem] sm:leading-[2rem] text-left sm:text-lg'>
                        ...
                        <motion.div className=' flex justify-between py-5 px-2' >
                            <motion.div
                                ...
                                <p className='text-lg font-medium pt-2 text-primaryDark/90 text-center'>  PE Liner bags</p>
                            </motion.div>
                            <motion.div
                                initial={{ y: 200 }}
                                whileInView={{ y: 0, transition: { duration: 0.9, ease: "easeInOut" } }}
                                viewport={{ once: true }}
                                className="flex flex-col items-center">
                                <h1 className='text-5xl font-bold'>6,000</h1>
                                <p className='text-lg font-medium pt-2 text-primaryDark/90text-center '>woven coated <br />
                                    PP/HDP Liners</p>
                            </motion.div>
                            <motion.div
                                initial={{ y: 200 }}
                                ...
                                className="flex flex-col items-center">
                                <h1 className='text-5xl font-bold'>15,000</h1>
                                <p className='text-lg font-medium pt-2 text-primaryDark/90 text-center'>Thermal / <br />
                                    Aluminium Liners</p>
                            </motion.div>
