...
const AboutUs = ({ className = "" }) => {
    ...
    leading-[60px] py-6  border-y-2 border-primaryDark '>UNITED PACKAGING CONSOLIDATORS</h2>
                    ...
                    <motion.div className='flex flex-col pl-12 lg:pl-0 '>
                        <motion.p
                            initial={{ y: 200 }}
                            whileInView={{ y: 0, transition: { duration: 0.9, ease: "easeInOut" } }}
                            viewport={{ once: true }}
                            className='p-2 text-xl text-dark font-normal leading-[2.25rem] xl:leading-[2rem] text-left sm:text-lg xs:text-base'>
                        ...
                        <motion.p
                            ...
                            whileInView={{ y: 0, transition: { duration: 0.9, ease: "easeInOut" } }}
                            viewport={{ once: true }}
                            className='p-2 text-xl text-dark font-normal leading-[2.35rem] xl:leading-[2rem] text-left sm:text-lg xs:text-base'>
                        ...
                        <motion.div className=' flex justify-between py-5 px-2' >
                            <motion.div
                                ...
                                <h1 className='text-5xl 2xl:text-4xl xl:text-3xl lg:text-3xl xs:text-2xl font-bold'>15,000</h1>
                                <p className='text-lg 2xl:text-base md:text-lg sm:text-base xs:text-sm pt-2 text-primaryDark/90 text-center'>  PE Liner bags</p>
                            </motion.div>
                            <motion.div
                                initial={{ y: 200 }}
                                whileInView={{ y: 0, transition: { duration: 0.9, ease: "easeInOut" } }}
                                viewport={{ once: true }}
                                className="flex flex-col items-center">
                                <h1 className='text-5xl 2xl:text-4xl xl:text-3xl lg:text-3xl xs:text-2xl font-bold'>6,000</h1>
                                <p className='text-lg 2xl:text-base md:text-lg sm:text-base xs:text-sm pt-2 text-primaryDark/90text-center '>woven coated <br />
                                    PP/HDP Liners</p>
                            </motion.div>
                            <motion.div
                                initial={{ y: 200 }}
                                ...
                                viewport={{ once: true }}
                                className="flex flex-col items-center">
                                <h1 className='text-5xl 2xl:text-4xl xl:text-4xl lg:text-3xl xs:text-2xl font-bold'>15,000</h1>
                                <p className='text-lg 2xl:text-base md:text-lg sm:text-base xs:text-sm pt-2 text-primaryDark/90 text-center'>Thermal / <br />
                                    Aluminium Liners</p>
                            </motion.div>
