...
const DunnageBenefits = ({ className = "" }) => {
    ...
    pb-0 mb-0 ${className} `} id='contactus ' >
            <Layout className='pt-0 bg-transparent !z-10 mx-32 xl:mx-12 lg:mx-6 '>
                ...
                <div className="py-12">
                    <AnimatedText text="Why use Crown’s Dunnage " className='!pt-24 !text-left text-primaryDark !text-6xl' />
                    <motion.p
                        initial={{ y: 200, opacity: 0 }}
                        whileInView={{ y: 0, opacity: 1, transition: { duration: 0.9, ease: "easeInOut" } }}
                        viewport={{ once: true }}
                        className='py-6 lg:py-3 xs:py-1 text-dark text-2xl lg:text-xl xs:text-base leading-10 text-left'>During transit, your packages may go through tough environmental
                        ...
                        absorb shock. Here are the three main benefits of using dunnage:</motion.p>
                    <div className='flex lg:flex-col items-center justify-between'>
                        <div className='flex flex-col  w-1/3 lg:w-full m-3 lg:m-2 xs:m-1 border border-primaryDark rounded-lg shadow-sm bg-secondaryLight/10 p-6'>
                            ...
                            <p className='text-lg lg:text-base xs:text-sm py-2'>
                                ...
                                valuable, fragile, and loose items. <br /><br />
                            </p>
                        </div>
                        <div className='flex flex-col w-1/3 lg:w-full m-3 lg:m-2 xs:m-1 border border-primaryDark rounded-lg shadow-sm bg-secondaryLight/10 p-6'>
                            <h2 className='text-2xl lg:text-xl xs:text-lg font-semibold text-primaryDark py-2'>
                    ...
                    <motion.p
                        ...
                        whileInView={{ y: 0, opacity: 1, transition: { duration: 0.9, ease: "easeInOut" } }}
                        viewport={{ once: true }}
                        className='py-6 lg:py-3 xs:py-1 text-dark text-2xl lg:text-xl xs:text-base leading-10 text-left'>To keep the goods in the containers from shifting vertically,
                    ...
                    <div className=' py-6 flex flex-col lg:flex-col items-start justify-between'>
                        ...
                        <div className='flex items-center sm:flex-col'>
                            ...
                            <div className="ml-12">
                                ...
                                <p className='text-xl lead lg:text-base xs:text-sm py-2'>
                                    oods can be shipped to you directly from our production plants to whichever customer/destination you
