        ...
        <div className='mb-12 mt-20 py-9 border-dark border-y border-opacity-10'>
            <div className='flex  justify-between'>
                ...
                <div className="flex flex-col items-center px-2">
                    <span className='inline-block text-7xl font-bold 2xl:text-6xl xl:text-5xl  sm:text-4xl xs:text-3xl'>
                        <AnimatedNumbers value={23} />+
                    </span>
                    <h2 className='text-xl font-medium capitalize text-dark/75   py-1
